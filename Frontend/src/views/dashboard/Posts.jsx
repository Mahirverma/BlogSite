...
function Posts() {
    ...
    const handleDeleteClick = (p_id) => {
        ...
        if(confirmed){
            fetchDeletePost(p_id);
        }
    };

    const fetchDeletePost = async (p_id) => {
        try{
            const post_res = await apiInstance.delete(`author/dashboard/destroy/${userId}/${p_id}/`);
            fetchPosts();
        } catch (error){
                                ...
                                <div className="card-header bg-transparent border-bottom p-3">
                                    <div className="d-sm-flex justify-content-between align-items-center">
                                        <h5 className="mb-2 mb-sm-0">
                                            All Blog Posts <span
                                            className="badge bg-primary bg-opacity-10 text-primary">{posts?.length}</span>
                                        </h5>
                                        ...
                                        <div className="col-md-8">
                                            <form className="rounded position-relative">
                                                <input onChange={(e) => handleSearch(e)}
                                                       className="form-control pe-5 bg-transparent" type="search"
                                        ...
                                        <table className="table align-middle p-4 mb-0 table-hover table-shrink">
                                            ...
                                            {posts?.map((p, index) => (
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            className="badge bg-dark bg-opacity-10 text-dark mb-2">{p.status}</span>
                                                    </td>
                                                    <td>
                                                        <div className="d-flex gap-2">
                                                            ...
                                                            <button className="btn-round mb-0 btn btn-danger"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Delete"
