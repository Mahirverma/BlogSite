                                        ...
                                        <div className="row gx-3">
                                            ...
                                            <div className="mb-3 col-12 col-md-12">
                                                ...
                                                <input type="text" id="fname" className="form-control"
                                                       ...
                                                       onChange={handleProfileChange} name="full_name"
                                            ...
                                            <div className="mb-3 col-12 col-md-12">
                                                ...
                                                <textarea onChange={handleProfileChange} name="about" id="" cols="30"
                                                          placeholder="Tell us about yourself"
                                                          value={profileData?.about} rows="5"
                                                          className="form-control"></textarea>
                                            </div>
                                            {/* Bio */}
                                            <div className="mb-3 col-12 col-md-12">
                                                <label className="form-label" htmlFor="editBio">
                                                    Bio
                                                </label>
                                                <input type="text" id="bio" className="form-control" placeholder="Bio"
                                                       required="" value={profileData?.bio}
                                                       onChange={handleProfileChange} name="bio"/>
                                            ...
                                            <div className="mb-3 col-12 col-md-12">
                                                ...
                                                <input type="text" id="country" className="form-control"
                                                       placeholder="Country" required="" value={profileData?.country}
                                                       onChange={handleProfileChange} name="country"/>
                                                <div className="invalid-feedback">Please choose country.</div>
                                            </div>
                                            {/* Facebook */}
                                            <div className="mb-3 col-12 col-md-12">
                                                ...
                                                <input type="text" id="facebook" className="form-control"
                                                       placeholder="Facebook" required="" value={profileData?.facebook}
                                                       onChange={handleProfileChange} name="facebook"/>
                                            </div>
                                            {/* Twitter */}
                                            <div className="mb-3 col-12 col-md-12">
                                                ...
                                                <input type="text" id="twitter" className="form-control"
                                                       placeholder="Twitter" required="" value={profileData?.twitter}
                                                       onChange={handleProfileChange} name="twitter"/>
                                            </div>
