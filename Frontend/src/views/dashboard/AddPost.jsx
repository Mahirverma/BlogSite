...
function AddPost() {
    ...
    const full_name = useUserData()?.full_name;
    ...
    const handleCreatePost = async (e) => {
        ...
        formdata.append("profile", full_name);
                                            ...
                                            <div className="offset-lg-1 col-lg-10 col-md-12 col-12">
                                                <div className="d-lg-flex align-items-center justify-content-between">
                                                    <div className="mb-4 mb-lg-0">
                                                        ...
                                                        <p className="mb-0 text-white lead">Use the form below to create
                                                            a new post.</p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="card mb-3">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <input onChange={handleCreatePostChange} name="title"
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <select name="category" onChange={handleCreatePostChange}
                                            ...
                                            <div className="mb-3">
                                                ...
                                                <textarea onChange={handleCreatePostChange} name="description"
                                                          className="form-control" id="" cols="30" rows="10"></textarea>
                                                <small>A brief summary of your posts.</small>
                                            </div>
                                            <label className="form-label">Tags</label>
                                            <input onChange={handleCreatePostChange} name="tags"
                                                   className="form-control" type="text"
                                                   placeholder="health, medicine, fitness"/>

                                            <div className="mb-3">
                                                <label className="form-label">Status</label>
                                                <select onChange={handleCreatePostChange} name="status"
                                                        className="form-select">
